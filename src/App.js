  ...
  render() {
    return (
      ...
      />
          ...
          <Routes>
                <Route exact path='/' element={ <NewsComponent setProgress={this.setProgress} apiKey={this.apiKey} key="general" pageSize={this.pageSize} country='in' catagory="general"/>}></Route>
